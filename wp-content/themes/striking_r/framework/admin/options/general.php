			...
			array(
				...
				"options" => array(
					array(
						...
						"desc" =>__("<p>This setting converts the site to a boxed layout type appearence, where the header and footer areas are constrained to the same width as the page body area, resulting in a top-to-bottom &#34;column&#34; look for the site.</p><p><em>NOTE:</em> &nbsp;&nbsp;&nbsp;&nbsp;In box mode the site content width is 1000px.</p><p><em>HINT:</em> &nbsp;&nbsp;Striking features many specific settings for the box mode, including the ability to set separately a box mode only for the blog page of the site if on so desires by way of the <b>Blog Box Frame Layout</b> setting as well as settings in the Striking Background panel and Striking Color panel specific to boxed layout usage.</p> ",'theme_admin'),
					...
					array(
						...
						"desc" =>  sprintf(__("<p>Use this setting to choose the look of the scroll button.&nbsp;&nbsp;The options are a circle or a square button appearence.&nbsp;&nbsp;One can also choose the color and hover color of the scroll button in the <a href='%s' target='_blank'>Color Panel/Scroll to Top Tab</a> section.",'theme_admin'),admin_url( 'admin.php?page=theme_color&tab=scrolltop')),
...
",'theme_admin'),
						"desc" => __("<p>This function fixes the sidebar area so that as one scrolls down the page, the sidebar remains fixed to the top of the page and always remains in sight.</p>",'theme_admin'),
						"id" => "stricky_sidebar",
						"default" => false,
						"type" => "toggle"
					),
