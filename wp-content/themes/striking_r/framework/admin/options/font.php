		...
		$options = array(
			array(
				...
				"options" => array(
					...
					array(
						'name' => __('Font icons integration', 'theme_admin'),
						'id' => 'icons',
						'default' => '',
						'options' => array(
							'' => __('None', 'theme_admin'),
			...
			array(
				...
				"options" => array(
					...
					array(
						"name" => __("Roundabout Slider Title Text Size",'theme_admin'),
						"desc" => "",
						"id" => "roundabout_title",
						"min" => "1",
						"max" => "60",
