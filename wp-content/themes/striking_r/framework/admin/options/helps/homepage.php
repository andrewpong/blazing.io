...
$help = <<<HTML
<h2 align="center" style="color:#0c4892">STRIKING HOMEPAGE	 PANEL</h2>
<p align="justify">Content TBD</p>
<p align="justify">This panel has 3 tabs for control of the the homepage options in the theme. &nbspEach resource tab has a <b>&#34;Help Information&#34;</b> link which you can click on to open/close a dropdown field containing detailed information on the functions of the resource tab, and most settings possess a help field where explanation of the setting is warranted.</p>

HTML;

$screen->add_help_tab( array(
	'id'      => 'homepagepanel',
	'title'   => __( 'Striking Homepage Panel' ),
	'content' => $help,
) );
