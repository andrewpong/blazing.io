...
$help = <<<HTML
<h2 align="center" style="color:#0c4892">STRIKING COLOR PANEL</h2>
<p align="justify">The Striking Color panel has 10 resource tabs containing over 110 color settings (at last count) for control of theme wide colors for different theme elements.  &nbsp;The resource tabs are organized along the lines of the webpage sections, and for certain major functions such as slideshows, blogs, portfolios, and tabs & accordions. &nbspSome resource tabs will have a <b>&#34;Help Information&#34;</b> link which opens a help dialogue of information on the functions within the resource tab, and most settings possess a help field when explanation of the setting is warranted.</p>
<p align="justify">Unlike most themes, Striking does not trap the user into a set group of color palettes (usually advertized as &#34;Skins&#34;), which is both very constraining, and is usually accompanied by  limited color options for the rest of site elements.  &nbsp;Our experience based on user feedback is that colors settings are normally very easy to work with for the average user -> the theme has a predefined launch color palette but one will find that one can quickly change colors on the fly as desired in order to vary the website to your needs. &nbsp;In fact, as colors are a readily graspable concept, even custom css for colors is straightforward for most beginners, and often a good place to commence some special creativity and learning some basic css.</p>
