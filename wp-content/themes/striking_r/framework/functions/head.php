...
function theme_enqueue_scripts() {
	...
	wp_register_script( 'tinyslider-init', THEME_JS .'/tinySliderInit.js', array('jquery','jquery-tinyslider'),false,$move_bottom);
	...
	if( !theme_get_option('advanced','no_fancybox') ){
		wp_enqueue_script( 'jquery-fancybox', THEME_JS .'/jquery.fancybox.js', array('jquery'),'2.1.3',$move_bottom);
		wp_enqueue_script( 'jquery-fancybox-media', THEME_JS .'/jquery.fancybox-media.js', array('jquery','jquery-fancybox'),'2.1.3',$move_bottom);
		wp_enqueue_script( 'jquery-fancybox-thumbs', THEME_JS .'/jquery.fancybox-thumbs.js', array('jquery','jquery-fancybox'),'2.1.3',$move_bottom);
	}
	wp_enqueue_script( 'swfobject', THEME_JS .'/swfobject.js', false,'2.3',$move_bottom);

	wp_register_script( 'jquery-sticker', THEME_JS .'/jquery-sticker.js', array('jquery'),'0.6.5',$move_bottom);
	if(theme_get_inherit_option(get_queried_object_id(), '_sticky_footer', 'footer','sticky_footer')){
		wp_enqueue_script( 'jquery-stickyfooter', THEME_JS .'/jquery.stickyfooter.js', array('jquery-sticker','enquire'),'1.0',$move_bottom);
	}
	if(theme_get_option('general','stricky_header')){
		wp_enqueue_script( 'jquery-stickyheader', THEME_JS .'/jquery.stickyheader.js', array('jquery-sticker','enquire'),'1.0',$move_bottom);
	}
	if(theme_get_option('general','stricky_sidebar')){
		wp_enqueue_script( 'jquery-stickysidebar', THEME_JS .'/jquery.stickysidebar.js', array('jquery-sticker','enquire'),'1.0',$move_bottom);
	}
	wp_register_script( 'jquery-navToSelect', THEME_JS .'/jquery-navtoselect.min.js', array('jquery'),false,$move_bottom);
	wp_register_script('enquire', THEME_JS . '/enquire.min.js', array('jquery'),false,$move_bottom);
	wp_register_script('jquery-imageLoaded', THEME_JS . '/jquery.imagesloaded.min.js', array('jquery'),false,$move_bottom);
	wp_register_script('jquery-adaptText', THEME_JS .'/jquery-adapttext.min.js', array('jquery'));
	wp_enqueue_script( 'custom-js', THEME_JS .'/custom.js', array('jquery','jquery-nav','jquery-tools-tabs','swfobject','jquery-navToSelect','enquire','jquery-imageLoaded','jquery-adaptText'),false,$move_bottom);
	...
	wp_register_script( 'jquery-css-animation', THEME_JS .'/unleash/jquery-animate-css-rotate-scale.js', array('jquery'),false,$move_bottom);
	wp_register_script( 'jquery-css-transform', THEME_JS .'/unleash/jquery-css-transform.js', array('jquery'),false,$move_bottom);
	wp_register_script( 'jquery-unleash', THEME_JS .'/unleash/jquery.unleash.1.2.js', array('jquery','jquery-easing','jquery-css-transform','jquery-css-animation'),'1.2',$move_bottom);
	wp_register_script( 'unleash-init', THEME_JS . '/unleashSliderInit.js',array('jquery-unleash'),false,$move_bottom);
	//Roundabout Slider
	wp_register_script( 'jquery-roundabout-shape', THEME_JS .'/roundabout/jquery.roundabout-shapes.js', array('jquery'),'1.0',$move_bottom);
	wp_register_script( 'jquery-roundabout', THEME_JS .'/roundabout/jquery.roundabout.js', array('jquery','jquery-easing','jquery-roundabout-shape'),'2.4.2',$move_bottom);
	wp_register_script( 'roundabout-init', THEME_JS . '/roundSliderInit.js',array('jquery-roundabout'),false,$move_bottom);
	//KenBurner Slider
	...
	wp_register_script( 'jquery-kenburner', THEME_JS .'/kenburner/jquery.themepunch.kenburn.js', array('jquery-kenburner-plugin'),false,$move_bottom);
	wp_register_script( 'ken-init', THEME_JS . '/kenSliderInit.js',array('jquery-kenburner'),false,$move_bottom);
	//Nivo Slider
	wp_register_script( 'jquery-nivo', THEME_JS .'/nivo/jquery.nivo.slider.js', array('jquery'),false,$move_bottom);
	wp_register_script( 'nivo-init', THEME_JS . '/nivoSliderInit.js',array('jquery-nivo'),false,$move_bottom);
...
function theme_enqueue_styles(){
	...
	if(theme_get_option('advanced','responsive')){
		wp_enqueue_style('theme-responsive', THEME_CSS.'/responsive.css', false, false, 'all');
	}
}
