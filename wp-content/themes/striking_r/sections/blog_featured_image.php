	...
	if($single){
		if(theme_get_option('blog', 'featured_image_lightbox')){
			if(theme_get_option('blog', 'featured_image_lightbox_gallery')){
				...
				$output .= '<img width="'.$width.'" height="'.$height.'" data-thumbnail="'.$thumbnail_id.'" src="'.$image_src.'" alt="'.get_the_title().'" />';
				$output .= '</a>';
			...
			if($effect!='none'){
				$output .= '<a class="image_icon_zoom" href="#" title="'.get_the_title().'"><img width="'.$width.'" height="'.$height.'" data-thumbnail="'.$thumbnail_id.'" src="'.$image_src.'" alt="'.get_the_title().'" /></a>';
			}else{
				$output .= '<a class="image_no_link" href="#" title="'.get_the_title().'"><img width="'.$width.'" height="'.$height.'" data-thumbnail="'.$thumbnail_id.'" src="'.$image_src.'" alt="'.get_the_title().'" /></a>';
			}
		}
	} else {
