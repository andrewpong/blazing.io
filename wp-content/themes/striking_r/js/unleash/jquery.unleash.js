 ...
 */ (function ($) {
    $.fn.unleash = function (options) {
        ...
        return this.each(function () {
            ...
            var y0 = (obj.width()) / ((obj.find(o.childClassName).length));
            obj.find(o.childClassName).each(function (i) {
                $(this).css({
                    left: (i * y0) + 'px'
                });
            ...
            $(window).resize(function () {
                ...
                if (o.SliderWidth.replace("px", "") > $(window).width()) {
                    ...
                    obj.find(o.childClassName).each(function (i) {
                        $(this).animate({
                            left: (i * (o.SliderWidth.replace("px", "")) / ((obj.find(o.childClassName).length))) + 'px'
                        }, {
                            queue: false,
                            duration: o.duration,
                            easing: o.easing
            ...
            if (o.Event == "hover") {
                obj.find(o.childClassName).hover(function () {
                    var hov = $(this);
                    var y = (((obj.width()) - o.width)) / ((obj.find(o.childClassName).length - 1));
