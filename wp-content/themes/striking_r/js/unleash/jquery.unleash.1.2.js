...
(function ($) {
    $.fn.unleash = function (options) {
        ...
        return this.each(function () {
            ...
            var y0 = (slider_width) / ((obj.find(o.childClassName).length));
            obj.find(o.childClassName).each(function (i) {
                $(this).css({
                    left: (i * y0) + 'px'
                });
            });
			o.width = o.width/o.SliderWidth;
			if(o.OpenFirstOnload){
			 obj.find(o.childClassName).eq(0).addClass('featured');
			 var y1 = (((obj.width()) - (obj.width()*o.width))) / ((obj.find(o.childClassName).length - 1));
			obj.find(o.childClassName).each(function (i) {
				if(i >= 1){
			...
			function hover_func() {
				 obj.find(o.childClassName).on('hover',function () {
                    var hov = $(this);
                    var y = (((obj.width()) - obj.width()*o.width)) / ((obj.find(o.childClassName).length - 1));
                    if(true){
			...
			function click_func() {
				obj.find(o.childClassName).on('click',function () {
                        var clk = $(this)
                        var y = (((obj.width()) - obj.width()*o.width)) / ((obj.find(o.childClassName).length - 1));
			...
			function collapse() {
                    ...
                    obj.find(o.childClassName).each(function (i) {
                        var $this = $(this);
                        $this.stop().animate({
                            left: (i * (obj.width()) / ((obj.find(o.childClassName).length))) + 'px'
                        }, {
                            queue: false,
                            duration: o.duration,
                            easing: o.easing
