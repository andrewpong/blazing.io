	...
	function tabs(){
		$options = array(
			...
			array(
				...
				"options" => array(
					array(
						"name" => __("Archive Page - &#34;<span class='theme_new_feature'>NEW FEATURE</span>&#34;",'theme_admin'),
						"id" => "archive",
						"default" => '',
						"options"=> theme_get_sidebar_options(),
						"prompt" => __("None",'theme_admin'),
					...
					array(
						"name" => __("Search Page - &#34;<span class='theme_new_feature'>NEW FEATURE</span>&#34;",'theme_admin'),
						"id" => "search",
						"default" => '',
						"options"=> theme_get_sidebar_options(),
						"prompt" => __("None",'theme_admin'),
					...
					array(
						"name" => __("Post Category Page - &#34;<span class='theme_new_feature'>NEW FEATURE</span>&#34;",'theme_admin'),
						"id" => "category",
						"default" => '',
						"options"=> theme_get_sidebar_options(),
						"prompt" => __("None",'theme_admin'),
					...
					array(
						"name" => __("Post Tag Page - &#34;<span class='theme_new_feature'>NEW FEATURE</span>&#34;",'theme_admin'),
						"id" => "tag",
						"default" => '',
						"options"=> theme_get_sidebar_options(),
						"prompt" => __("None",'theme_admin'),
					...
					array(
						"name" => __("Post Date Page - &#34;<span class='theme_new_feature'>NEW FEATURE</span>&#34;",'theme_admin'),
						"id" => "date",
						"default" => '',
						"options"=> theme_get_sidebar_options(),
						"prompt" => __("None",'theme_admin'),
					...
					array(
						"name" => __("Author Page - &#34;<span class='theme_new_feature'>NEW FEATURE</span>&#34;",'theme_admin'),
						"id" => "author",
						"default" => '',
						"options"=> theme_get_sidebar_options(),
						"prompt" => __("None",'theme_admin'),
