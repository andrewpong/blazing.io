			...
			<ul id="list_slides" class="list_slides ui-sortable">
				...
				?>
					<li id="slidelist_item_<?php echo $slideid?>" class="ui-state-default">
						...
						<div class="clear"></div>
						<?php if(!empty($urlFlag)):?>
						<img id="icon_lang_<?php echo $slideid?>" class="icon_slide_lang" src="<?php echo $urlFlag?>" title="<?php echo $langTitle?>" data-slideid="<?php echo $slideid?>" data-lang="<?php echo $lang?>">
