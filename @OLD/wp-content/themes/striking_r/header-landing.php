...
<!--[if IE]>
	<script type='text/javascript' src='<?php echo THEME_JS;?>/media.match.min.js'></script>
<![endif]-->
...
?>
<div id="logo">
	<a href="#"><img class="ie_png" src="<?php echo theme_get_image_src($custom_logo); ?>" alt="<?php bloginfo('name'); ?>"/></a>
