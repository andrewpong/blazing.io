...
jQuery(document).ready(function($) {
    ...
    $('#navigation > ul').navToSelect({
            ...
            defaultText: nav2select_defaultText,
            indentSpace: true
        });
    ...
    var enable_lightbox = function(selector, parent) {
        ...
        var options = {
            ...
            beforeLoad: function() {
                if (this.element.is('.fancyaudio')) {
                    ...
                    var id = Math.round(Math.random() * 10000 + 1);
                    this.content = '<div class="video_frame" style="width:' + this.width + 'px;height:' + this.height + 'px">' +
        ...
        $(selector, parent).fancybox(options);
    };
    ...
    $(".portfolios").each(function() {
        ...
        if ($section.is('.sortable')) {
            ...
            var $callback = function() {
                ...
                $list.find('.image_frame').each(function() {
                    if ($(this).is('.effect-grayscale')) {
                        if ($(this).find('.grayscale-wrapper').size() === 0 && $(this).find('.image-on-loading').size() === 0) {
            ...
            if ($ajax) {
                $('.wp-pagenavi a', this).live('click', function(e) {
                    var category = 'all';
